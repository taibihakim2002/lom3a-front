...
import { cn } from "@/lib/utils"; // (مطلوب للكلاسات الشرطية)
                          ...
                          <FormControl>
                            <div className="relative">
                              <Input 
                                ...
                                className={cn(
                                  "pr-10 text-right",
                                  fieldState.invalid && "bg-destructive/10 border-destructive focus-visible:ring-destructive"
                                )}
                              />
