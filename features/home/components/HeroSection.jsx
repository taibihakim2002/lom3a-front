...
export default function HeroSection() {
  ...
  return (
    ...
    >
      {/* ✅ 1. صورة الخلفية (LCP): خارج LazyMotion تماماً لتظهر فوراً */}
      <div className="absolute inset-0 -z-10">
        <Image
          ...
          fill
          priority // ضروري جداً
          quality={70} // تقليل الجودة قليلاً لتحسين السرعة
      ...
      {/* ✅ 2. المحتوى المتحرك فقط هو من نضعه داخل LazyMotion */}
      ...
      {/* الموجة السفلية (خارج الحركة لأنها ثابتة) */}
